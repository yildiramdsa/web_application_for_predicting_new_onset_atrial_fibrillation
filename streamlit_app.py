...
def render_form():
    with st.form(key=st.session_state["form_key"], clear_on_submit=False):
        ...
        st.write("_Select all that apply: Observations recorded at any time prior to or within 6 months after the index ECG._")
        c1, c2, c3 = st.columns(3)
        ...
        st.write("_Select all that apply: Observations recorded at any time prior to the index ECG._")
        ...
        st.write("_Enter all that apply: Measurements taken within 3 years prior to or 1 year after the index 12-lead ECG._)
        ...
        st.write("_Enter all that apply: Measurements taken within 3 years prior to or 1 year after the index 12-lead ECG.")
        ...
        st.write("_Select all that apply: Usage recorded within 90 days before or after the index 12-lead ECG._")  
